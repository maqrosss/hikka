...
lol = ["я типя тожи", "ты педик?", 'асуууууууууууу', 'ичо', 'пиздец', 'явахуе', 'так ей и сказал?', 'флоресто фуре', 'попа пиписька кашака', 'я клик', 'БЛЯТЬ МЕНЯ ВЗЛОМАЛИ', 'ичо блять чмо', 'не бань пршу', 'даймне пососать', 'не', ',kz', 'pidor', 'ну и иди нахуй чмо']
msgsl = ["ку", 're', 'dev', 'динахуй','иди нахуй','дон','я дон', 'клик', 'я тебя люблю', 'я типя люблю', 'я тебя любл', 'чо как', 'как дела', 'дарова', 'дорова', 'педик', 'сам такой', 'я маму дева ел', 'иди газуй', 'чмо', 'сам такой', ',kz', 'клик', 'сиськи', 'ок', 'мафию', 'го в мафию', 'мафия']

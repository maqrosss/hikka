...
msgsl = ["ку", 're', 'dev', 'динахуй','иди нахуй','дон','я дон', 'клик', 'я тебя люблю', 'я типя люблю', 'я тебя любл', 'чо как', 'как дела', 'дарова', 'дорова', 'педик', 'сам такой', 'Я маму дева ел', 'Иди газуй']
